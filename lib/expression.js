...
CronExpression.prototype._findSchedule = function _findSchedule () {
  ...
  function checkDST(currentDate, method) {
    var previousHour = currentDate.getHours();
    currentDate[method]();
    currentHour = currentDate.getHours();
    if (currentHour - previousHour === 2) {
      console.log(method + ' - STARTING DST');
      if (this._fields.hour.length === 24) {
        console.log(method + ' - HOUR is *');
      } else {
        console.log(method + ' - HOUR is specified');
  ...
  while (true) {
    ...
    if (!matchSchedule(currentDate[method('getHours')](), this._fields.hour)) {
      if ((this.dstStart !== currentDate[method('getHours')]())) {
        this.dstStart = null;
        checkDST.call(this, currentDate, 'addHour');
        continue;
      }
      // console.log('getHours: ' + currentDate.dstStart);
      // if (!currentDate.dstStart) {
      //   previousHour = currentDate.getHours();
      //   currentDate.addHour();
      //   currentHour = currentDate.getHours();
      //   if (currentHour - previousHour === 2) {
      //     console.log('HOUR - STARTING DST');
      //     if (this._fields.hour.length === 24) {
      //       console.log('HOUR - HOUR is *');
      //     } else {
      //       console.log('HOUR - HOUR is specified');
      //       currentDate.dstStart = true;
      //     }
      //   }
    ...
    if (!matchSchedule(currentDate[method('getMinutes')](), this._fields.minute)) {
      ...
      checkDST.call(this, currentDate, 'addMinute');
      continue;
    }
    ...
    if (!matchSchedule(currentDate[method('getSeconds')](), this._fields.second)) {
      // previousHour = currentDate.getHours();
      // currentDate.addSecond();
      checkDST.call(this, currentDate, 'addSecond');
      continue;
    }
    ...
    //     console.log('ENDING DST');
    //     // if (this._fields.hour.length === 24) {
    //     //   console.log('HOUR is *');
    //     // } else {
    //     //   console.log('HOUR is specified');
    //     // }
    //   } else if (currentHour - previousHour === 2) {
    //     console.log('STARTING DST');
    //     // if (this._fields.hour.length === 24) {
    //     //   console.log('HOUR is *');
    //     // } else {
    //     //   console.log('HOUR is specified');
